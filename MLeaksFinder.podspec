...
#                       DESC
  ...
  s.homepage         = "https://github.com/fanyunfei786452470/MLeaksFinder"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Zeposhe" => "zeposhe@163.com" }
  s.source           = { :git => "https://github.com/fanyunfei786452470/MLeaksFinder", :tag => s.version }
  ...
  s.dependency 'FBRetainCycleDetector', 'master'
end
